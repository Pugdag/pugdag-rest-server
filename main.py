...
from endpoints import get_balance, get_utxos, get_blocks, get_blockdag, get_circulating_supply, get_pugdagd_info, \
...
from endpoints.pugdagd_requests.submit_transaction_request import submit_a_new_transaction
from helper import get_pug_market_data
...
print(
    ...
    f"{get_pugdagd_info}, {get_network}, {get_marketcap}, {get_hashrate}, {get_blockreward}"
...
async def startup():
    ...
    # get pugdagd
    await get_pug_market_data()

    # find pugdagd before staring webserver

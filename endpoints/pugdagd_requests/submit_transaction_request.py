...
async def submit_a_new_transaction(body: SubmitTransactionRequest):
    """
    Forwards the body directly to pugdagd with the command submitTransactionRequest
    """
    tx_resp = await pugdagd_client.request("submitTransactionRequest",
                                          params=body.dict())

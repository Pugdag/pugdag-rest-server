...
@app.get("/info/hashrate", response_model=HashrateResponse | str, tags=["Pugdag network info"])
...
@app.get("/info/hashrate/max", response_model=MaxHashrateResponse, tags=["Pugdag network info"])
@sql_db_only

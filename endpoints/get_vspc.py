...
@app.get("/info/get-vscp-from-block", response_model=VscpResponse, tags=["Pugdag network info"])
async def get_virtual_selected_parent_chain_from_block(
    ...
    some startHash to this pugdagd's current virtual.
    """
    resp = await pugdagd_client.request("getVirtualSelectedParentChainFromBlockRequest",
                                       params={
                                           "startHash": startHash,
